...
<html lang="en">
	...
	<script>
$('body').on('click', '.elementMenu', function()
{
localStorage.setItem('active1', $('li.elementMenu').attr('href'));
});
</script>
		...
		<div >
			...
			<div class="row">
			<div class="col-xs-12 col-sm-8 col-md-6" id="logo"><h1><a href="/">Pixel.ru</a></h1></div>
